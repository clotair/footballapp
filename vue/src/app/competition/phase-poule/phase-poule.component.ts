...
export class PhasePouleComponent implements OnInit {
  ...
  constructor(
    ...
    comp.poule1.subscribe((e)=>{
      ...
      this.gp2_j3.next([t2.matchs[4],t2.matchs[2]]);
      this.gp3_j1.next([t3.matchs[0],t3.matchs[5]]);
      this.gp3_j2.next([t3.matchs[2],t3.matchs[4]]);
      this.gp3_j3.next([t3.matchs[1],t3.matchs[3]]);
      this.gp4_j1.next([t4.matchs[0],t4.matchs[3]]);
      this.gp4_j2.next([t4.matchs[2],t4.matchs[4]]);
      this.gp4_j3.next([t4.matchs[1],t4.matchs[5]]);
